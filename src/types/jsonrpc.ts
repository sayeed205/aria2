 ...
 */
export interface Aria2Method<TParams extends unknown[] = unknown[], TResult = unknown> {
  /** Method name */
  method: string;
  /** Parameter types */
  params: TParams;
 ...
 */
export type Aria2MethodParams<T> = T extends Aria2Method<infer P, unknown> ? P : never;

/**
 * Type-safe aria2 method result extraction
 */
export type Aria2MethodResult<T> = T extends Aria2Method<unknown[], infer R> ? R : never;
...
export interface Aria2MethodSignatures {
  ...
  'aria2.addTorrent': Aria2Method<[string, string[]?, Record<string, unknown>?], string>;
  'aria2.addMetalink': Aria2Method<[string, Record<string, unknown>?], string[]>;
  ...
  'aria2.tellWaiting': Aria2Method<[number, number, string[]?], Record<string, unknown>[]>;
  'aria2.tellStopped': Aria2Method<[number, number, string[]?], Record<string, unknown>[]>;
